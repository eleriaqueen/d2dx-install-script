...
# Attempt to retrieve Diablo II path from registry value if it exists
$d2regpath = 'HKCU:\SOFTWARE\Blizzard Entertainment\Diablo II'
$d2regprop = 'InstallPath'
$d2path = (Get-ItemProperty $d2regpath)| Select-Object -ExpandProperty $d2regprop
...
{
    Write-Output("Found existing `'glide3x.dll`' dll in Diablo II folder")
